...
def plot_alignment(
    alignment: AlignmentForPlot, show_line_position: bool = False,
    color_symbols: bool = False, show_similarity: bool = False,
    ...
    fig.tight_layout()
    return savefig_to_b64(fig=fig, format=image_format)
